...
public final class FragmentTipsBinding implements ViewBinding {
  ...
  private FragmentTipsBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerViewTips) {
  ...
  public static FragmentTipsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTipsBinding((ConstraintLayout) rootView, recyclerViewTips);
    }
